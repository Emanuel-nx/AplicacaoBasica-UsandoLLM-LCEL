...
llm = ChatGroq(
    model = "Gemma2-9b-It", # MODELO DE LLM UTILZADO
    groq_api_key = groq_api_key, # CHAVE DE API DO GROQ
)

# 2 - PARSER DE SÁIDA ; Isso é necessario para que o sistema entenda a saída do modelo
parser = StrOutputParser()

# 3 - Prompt Template: Usando LCEL - Chain the Components
generic_template = "Traduza a seguinte farse em {language}"
